...
readonly EXPECTED_VLLM_COMMIT="1d6b37c8eb904bb2d1db7ddd05b002157d5e9f26"
readonly EXPECTED_VLLM_TREE="1260b4aba8fb5bf92e6632882326eb2b800ff3df"
readonly EXPECTED_CAPACITY_IMAGE_ID="sha256:f56910530683326051cfdf4e7c8e4d6afc5bace8804cb78b2af9ea799bbba4e6"
readonly EXPECTED_DOCKERFILE_SHA256="6014fd3703132fc9e06f27dcf3ac0e6c8ac129b5aee3046f405054fd6de738dc"
...
readonly IMAGE_TAG="${2:-club-3090/deepseek-v4-wna16-sm86:quality-12035985-speed-1d6b37c8}"
...
for path in "$ENVS_PATH" "$CUDA_COMMUNICATOR_PATH" "$AMPERE_SPARSE_PATH"; do
